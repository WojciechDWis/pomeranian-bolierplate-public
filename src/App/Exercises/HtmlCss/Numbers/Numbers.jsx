...
export function Numbers() {
  ...
  // === RÓWNE (RAZME Z TYPEM ZMIENNEJ)
  // == RÓWNE (NIE UWZGLĘDNIAJĄC TYPU ZMIENNEJ)
  const a = 5;
  const b = '5';
  const c = 7;
  ...
  console.log(parseInt('0.9999')); //0 x2
  console.log(parseFloat(11)); // 11.0 x2

  // NaN - not a number - typ prosty (działanie matematyczne niedozwolone np. = 100 / 'Apple')
  // isNaN() - sprawdzanie czy wartośc nie jest liczbą

  // toString() - wywołaj metodę odpowiedzialną za przerobienie wartości liczbowej na string
  const toStringVariable = 42;
  console.log(toStringVariable.toString()); // '42' x2

  // toFixed() - wywołaj metodę odpowiedzialną za zaookrąglenie wartości do X miejsca po przecinku
  const toFixedVal = 3.141525;
  console.log(toFixedVal.toFixed(3)); // 3.14 x2

  // Math.round() - wywołaj metodę odpowiedzlną za zaookrąglenie liczby do najbliższej liczby całkowitej
  ...
  // Math.min() - wywołaj metodę opdowiedzialną za wyszukanie najmniejszej liczby
